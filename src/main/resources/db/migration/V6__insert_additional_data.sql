...
VALUES
    (12, now(), now(), '77032221100', '$2a$10$DloIFFbe/Zak9m3M.bUh3O93DCYel873exKgir3l/3k7/xl2Zwzjy', 'PARENT'),
...
-- PARENTS
INSERT INTO parents (id, created_date, update_date, first_name, last_name, phone_number, birth_date, email, address, balance, auth_user_id)
VALUES
    (12, now(), now(), 'Aisulu', 'Nur', '77032221100', '1991-01-01', 'aisulu@mail.kz', 'Samal 12', 120000, 12),
...
INSERT INTO auth_users (id, created_date, update_date, phone_number, password, role)
VALUES
    (22, now(), now(), '77071112233', '$2a$10$DloIFFbe/Zak9m3M.bUh3O93DCYel873exKgir3l/3k7/xl2Zwzjy', 'CHILD'),
...
-- CHILDREN
INSERT INTO children (id, created_date, update_date, first_name, last_name, phone_number, email, birth_date, auth_user_id, gender, parent_id)
VALUES
    (22, now(), now(), 'Samat', 'Nur', '77071112233', 'samat@edu.kz', '2012-06-15', 22, 'MALE', 12),
...
VALUES
    (22, 1),  -- Samat в Scratch
    (23, 2),  -- Dana в Math
    (24, 3);  -- Adil в English


-- PAYMENTS
INSERT INTO payments (id, created_date, update_date, payment_time, amount, percent_of_vat, payment_method, payment_status, transaction_id, child_id, course_id, parent_id)
VALUES
    (31,now(), now(), '2025-02-10', 15000, 12, 'CARD', 'PAID', 'TXN101', 22, 1, 12),
...
VALUES
    (now(), now(), 31, gen_random_uuid(), 'Оплата Scratch', 'https://example.com/receipt101.pdf', 'Kaspi'),
