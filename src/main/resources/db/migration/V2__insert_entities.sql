...
VALUES
    (1, now(), now(), 1, 'Знакомство с Scratch', 'Введение в интерфейс среды Scratch. Создание первого проекта.', 1, 1, '', '2025-01-10'),
    (2, now(), now(), 2, 'Сцены и спрайты', 'Добавление спрайтов, изменение фонов, основы визуального дизайна.', 1, 1, '', '2025-01-12'),
    (3, now(), now(), 3, 'Движение объектов', 'Программирование перемещения спрайтов с помощью блоков.', 1, 1, '', '2025-01-14'),
    (4, now(), now(), 4, 'Анимация', 'Создание анимации через смену костюмов и координат.', 1, 1, '', '2025-01-16'),
    (5, now(), now(), 5, 'События и реакции', 'Использование событий (например, при нажатии клавиш) для запуска сценариев.', 1, 1, '', '2025-01-18'),
    (6, now(), now(), 6, 'Звуки и музыка', 'Добавление звуков и создание музыкальных эффектов.', 1, 1, '', '2025-01-20'),
    (7, now(), now(), 7, 'Циклы и повторения', 'Применение блоков повторения для оптимизации кода.', 1, 1, '', '2025-01-22'),
    (8, now(), now(), 8, 'Условия (if)', 'Создание интерактивности через условные блоки.', 1, 1, '', '2025-01-24'),
    (9, now(), now(), 9, 'Переменные', 'Введение в переменные. Отслеживание очков и счётчиков.', 1, 1, '', '2025-01-26'),
    (10, now(), now(), 10, 'Мини-игра: Лабиринт', 'Создание простой игры, где спрайт проходит через лабиринт.', 1, 1, '', '2025-01-28'),
    (11, now(), now(), 11, 'Итоговый проект: Моя игра', 'Работа над собственным проектом с использованием изученных элементов.', 1, 1, '', '2025-01-30'),
    (12, now(), now(), 12, 'Презентация проектов', 'Представление работ, обсуждение, обратная связь и закрепление знаний.', 1, 1, '', '2025-02-01');
